...
Beware that this integration does not work with Eve Motionblinds motors. Eve Motionblinds can be added to Home Assistant using the [HomeKit Device](/integrations/homekit_controller/) integration or the [Matter](/integrations/matter/) integration.
...
- [Cover](/integrations/cover/) entity: depending on the blind that was chosen during the setup, this entity has a slider that makes it possible to change position and tilt, and buttons that allow you to open the blind, close the blind, tilt it open, tilt it closed and stop it.
- [Button](/integrations/button/) entities:
...
- [Select](/integrations/select/) entities:
